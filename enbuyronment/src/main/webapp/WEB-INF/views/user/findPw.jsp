			...
			<div class="col-md-4 col-md-offset-4">
				...
				<form class="fh5co-form animate-box" data-animate-effect="fadeIn">
					...
					<div class="form-group">
						<label for="id" class="sr-only">아이디</label> <input type="text"
							name="uid" class="form-control" id="id" placeholder="아이디"
							autocomplete="off">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input type="button" value="임시 비밀번호 발급" class="btn btn-primary"
							id="findPwBtn">
					</div>
				</form>
				<!-- END Sign In Form -->
